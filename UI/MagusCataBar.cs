...
{
    internal class MagusCataBar : UIState
    {
        private UIText text;
        ...
        public override void OnInitialize()
        {
            ...
            gradientA = new Color(123, 35, 138);
        ...
        protected override void DrawSelf(SpriteBatch spriteBatch)
        {
            ...
            float quotient = (float)modPlayer.MagusCataCurrent / modPlayer.MagusCataMax2;
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            var modPlayer = Main.LocalPlayer.GetModPlayer<MagusClassDamagePlayer>();
            text.SetText($"Cataclysm: {modPlayer.MagusCataCurrent} / {modPlayer.MagusCataMax2}");
