...
{
    internal class MagusSataBar : UIState
    {
        private UIText text;
        ...
        public override void OnInitialize()
        {
            ...
            barFrame = new UIImage(GetTexture("Stellarium/UI/MagusSataFrame"));
            ...
            gradientA = new Color(22, 162, 26);
            gradientB = new Color(22, 243, 26);
        ...
        protected override void DrawSelf(SpriteBatch spriteBatch)
        {
            ...
            float quotient = (float)modPlayer.MagusSataCurrent / modPlayer.MagusSataMax2;
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            var modPlayer = Main.LocalPlayer.GetModPlayer<MagusClassDamagePlayer>();
            text.SetText($"Satanism: {modPlayer.MagusSataCurrent} / {modPlayer.MagusSataMax2}");
