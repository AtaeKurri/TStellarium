...
{
    class EnergeticVampire : MagusClassDamageItem
    {
        public override void SetStaticDefaults()
        {
            Tooltip.SetDefault("Being hit by an ennemy regenerates Satanism energy");
        }
        ...
        public override void UpdateAccessory(Player player, bool hideVisual)
        {
            ...
            modPlayer.EnergeticVampire = true;
        }
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(ItemType<Materials.SatanismEssence>(), 10);
